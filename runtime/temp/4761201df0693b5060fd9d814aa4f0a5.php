<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"E:\wamp64\www\duncan\public/../application/bis\view\location\index.html";i:1500077579;s:70:"E:\wamp64\www\duncan\public/../application/bis\view\public\header.html";i:1489469584;s:70:"E:\wamp64\www\duncan\public/../application/bis\view\public\footer.html";i:1489469584;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
  ...
  <div class="mt-20">
    <table class="table table-border table-bordered table-bg table-hover table-sort">
      ...
      <tr class="text-c">
        ...
        <td><?php if($vo['is_main'] == '1'): ?>总店<?php else: ?> 分店<?php endif; ?></td>
        <td class="td-status"><a href="<?php echo url('location/status',['id'=>$vo['id'], 'status'=>1]); ?>" title="点击修改状态"><?php echo status($vo['status']); ?></a></td>
