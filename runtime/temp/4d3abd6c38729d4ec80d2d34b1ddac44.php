<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:57:"/home/o2o/public/../application/index/view/pay/index.html";i:1500609744;s:59:"/home/o2o/public/../application/index/view/public/head.html";i:1500429940;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<div>
            ...
            <table width="100%">
                ...
                <tr>
                    <td class="fl_left ">
                        <ul class="order-list">
                            <li>
                                <span class="order-list-no">订单<?php echo $deal['id']; ?>:</span>
    ...
    <div align="center"><h1 class="title">使用微信扫码支付方式</h1><img src="/weixin/example/qrcode.php?data=<?php echo $url; ?>" alt="微信扫码支付" style="width:300px;height:300px;"></div>
