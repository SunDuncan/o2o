<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"E:\wamp64\www\duncan\public/../application/admin\view\category\index.html";i:1500073137;s:72:"E:\wamp64\www\duncan\public/../application/admin\view\public\header.html";i:1489469584;s:72:"E:\wamp64\www\duncan\public/../application/admin\view\public\footer.html";i:1489469584;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
		...
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<tbody>
				...
				<tr class="text-c">
					...
					<td class="td-manage"><a href="<?php echo url('category/index',['parent_id'=>$vo['id']]); ?>">获取子栏目</a><a style="text-decoration:none" class="ml-5" onClick="o2o_s_edit('编辑','<?php echo url('category/edit', ['id'=>$vo['id']]); ?>','',300)" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> <a style="text-decoration:none" class="ml-5"  href="<?php echo url('category/status', ['id'=>$vo['id'], 'status'=>-1]); ?>" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
				</tr>
